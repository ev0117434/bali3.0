...
# -*- coding: utf-8 -*-
"""
Gate.io Futures (USDT Perpetual) — market data collector.
WS: fx-ws.gateio.ws/v4/ws/usdt  Channel: futures.book_ticker
Redis key: md:gt:f:{SYMBOL}  Fields: b (bid), a (ask), t (exchange ts ms)
