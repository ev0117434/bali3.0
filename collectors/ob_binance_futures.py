...
# -*- coding: utf-8 -*-
"""
Binance Futures (USD-M) — order book collector (10 levels).
WS: fstream.binance.com  Channel: @depth10@100ms
Redis key: ob:bn:f:{SYMBOL}
Fields: b1..b10 (bid prices), bq1..bq10 (bid qty),
        a1..a10 (ask prices), aq1..aq10 (ask qty), t (local ms)

Protocol notes:
- Identical to ob_binance_spot except WS host, subscribe file, and field names
- fstream endpoint for USD-M perpetuals
- Futures depth messages use fields "b"/"a" (NOT "bids"/"asks" like spot)
  data format: {"e":"depthUpdate","s":"BTCUSDT","b":[[p,q]...],"a":[[p,q]...]}
"""
            ...
            async with websockets.connect(
                ...
                async for raw in ws:
                    ...
                    try:
                        ...
                        # Futures depth uses "b"/"a"; spot uses "bids"/"asks"
